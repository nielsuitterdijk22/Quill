...
function DeletePolicyForm({
  ...
  const action = deleteBranchPolicyAction.bind(null, project, repo);
...
export function PolicyManager({
  ...
  const action = setBranchPolicyAction.bind(null, project, repo);
            ...
            {policies.map((p) => (
              <tr key={p.pattern}>
                ...
                <td className="policy-row-actions">
                  ...
                  <DeletePolicyForm project={project} repo={repo} pattern={p.pattern} />
                </td>
              </tr>
            ))}
          </tbody>
