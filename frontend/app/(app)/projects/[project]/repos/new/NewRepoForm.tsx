...
export function NewRepoForm({ project }: { project: string }) {
  // Bind the project slug into the server action.
  const action = createRepoAction.bind(null, project);
      ...
      <div className="readme-body">
        ...
        <form action={formAction}>
          ...
          <div className="form-actions">
            <SubmitButton />
            <Link className="btn ghost" href={`/projects/${project}`}>
              Cancel
            </Link>
          </div>
        </form>
